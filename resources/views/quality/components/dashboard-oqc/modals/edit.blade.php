        ...
        <div class="modal-body">
          <form class="row g-3" method="POST" action="/quality/dashboard-oqc/{{ $d->id }}">
              ...
              <div class="col-6">
                  ...
                  <textarea name="action" id="action" class="form-control" style="height: 100px" {{ ((auth()->user()->departement == 'qc') || (auth()->user()->departement == 'it')) ? '' : 'readonly disabled' }}>{{ $d->action }}</textarea>
              </div>
              <div class="col-12 text-center">
                  <label for="pembahasan" class="form-label">Pembahasan</label>
                  <input type="text" class="form-control" id="pembahasan" name="pembahasan" value="{{ $d->pembahasan }}" {{ ((auth()->user()->departement == 'qc') || (auth()->user()->departement == 'it')) ? '' : 'readonly disabled' }}>
              </div>
              <div class="col-12 text-center">
