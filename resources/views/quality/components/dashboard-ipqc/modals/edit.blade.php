        ...
        <div class="modal-body">
          <form class="row g-3" method="POST" action="/quality/dashboard-ipqc/{{ $d->id }}">
              ...
              <div class="col-6">
                  ...
                  <select class="form-select" aria-label="Default select example" name="departement" id="departement" {{ (auth()->user()->departement == 'qc') ? '' : 'disabled' }} required>
              ...
              <div class="col-6">
                  ...
                  <select class="form-select" aria-label="Default select example" name="section" id="section" {{ (auth()->user()->departement == 'qc') ? '' : 'disabled' }} required>
              ...
              <div class="col-6">
                  ...
                  <input type="text" class="form-control" id="no_ncr_lot" name="no_ncr_lot" value="{{ $d->no_ncr_lot }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="part_no" class="form-label">Part No <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="part_no" name="part_no" value="{{ $d->part_no }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="lot_no" class="form-label">Lot No <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="lot_no" name="lot_no" value="{{ $d->lot_no }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="mesin" class="form-label">Mesin <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="mesin" name="mesin" value="{{ $d->mesin }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="status" class="form-label">Status <span class="text-danger">*</span></label>
                  <select class="form-select" aria-label="Default select example" name="status" id="status" {{ (auth()->user()->departement == 'qc') ? '' : 'disabled' }} required>
              ...
              <div class="col-6">
                  ...
                  <select class="form-select" aria-label="Default select example" name="keterangan" id="keterangan" {{ (auth()->user()->departement == 'qc') ? '' : 'disabled' }} required>
              ...
              <div class="col-6">
                  ...
                  <input type="text" class="form-control" name="defect" id="defect" value="{{ $d->defect }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="standard" class="form-label">Standard <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="standard" id="standard" value="{{ $d->standard }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="actual" class="form-label">Actual <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="actual" name="actual" value="{{ $d->actual }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="sampling" class="form-label">Sampling Qty <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="sampling" name="sampling" value="{{ $d->sampling }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="qty_check" class="form-label">Qty Check <span class="text-danger">*</span></label>
                  <input type="number" class="form-control" id="qty_check" name="qty_check" value="{{ $d->qty_check }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
              ...
              <div class="col-6">
                  ...
                  <input type="date" class="form-control" id="date" name="date" value="{{ $d->date }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
                  <label for="deadline" class="form-label">Deadline <span class="text-danger">*</span></label>
                  <input type="date" class="form-control" id="deadline" name="deadline" value="{{ $d->deadline }}" {{ (auth()->user()->departement == 'qc') ? '' : 'readonly disabled' }} required>
              </div>
              <div class="col-6">
              ...
              <div class="col-12 text-center">
                  ...
                  <input type="text" class="form-control" id="verifikasi_qa" name="verifikasi_qa" value="{{ $d->verifikasi_qa }}" {{ (auth()->user()->departement == 'qa') ? '' : 'readonly disabled' }} >
              </div>
