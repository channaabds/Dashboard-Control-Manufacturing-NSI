      ...
      <div class="modal-body">
        <form class="row g-3" method="POST" action="/quality/dashboard-ipqc/{{ $d->id }}">
            ...
            <div class="col-6">
                ...
                <select class="form-select" aria-label="Default select example" name="departement" id="departement" disabled>
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control" id="pic_departement" name="pic_departement" value="{{ $d->pic_departement }}">
            </div>
            <div class="col-6">
