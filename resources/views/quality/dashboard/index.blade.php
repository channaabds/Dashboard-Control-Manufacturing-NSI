...
<main id="main" class="main">
  ...
  @endif
  <div class="pagetitle">
    <h1>Dashboard Data claim NCR dan Lot Tag {{ $departement }}</h1>
  </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex justify-content-between">
              <h5>Data Claim NCR dan Lot Tag {{ $departement }}</h5>
              <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#tambahData">
                Tambah Data
              </button>
              @include('quality.components.dashboard.modals.tambah')
            </div>
...
@include('quality.components.dashboard.dataTable')
