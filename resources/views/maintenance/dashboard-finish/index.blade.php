...
@section('content')
                                ...
                                <form action="/export/machine-finish" method="post">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td scope="col"><input type="text" class="form-control" id="min"
                                                    name="min"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col"><input type="text" class="form-control" id="max"
                                                    name="max"></td>
                                        </tr>
                                    </tbody>
                                </form>
                            ...
                            <table class="table table-bordered table-striped"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <?php if(auth()->user()->username == 'admin' || auth()->user()->username == 'manager'): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button class="btn btn-danger mb-1" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#deleteModal{{ $machineFinish->id }}">Hapus</button>
    ...
    @include('maintenance.components.dashboard-finish.dataTable')
@endsection
